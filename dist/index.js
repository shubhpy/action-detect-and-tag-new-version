...
exports.determineContent = void 0;
...
exports.determineContent = determineContent;
function determineCommand() {
    let command = core_1.getInput('diff-on-content');
    if (command) {
        return command;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
const core_1 = __webpack_require__(470);
const determine_content_1 = __webpack_require__(51);
...
async function run() {
    ...
    let previousContent = await determine_content_1.determineContent();
    core_1.info(`Previous Content: ${previousContent}`);
    core_1.setOutput('previous-content', previousContent);
    await git_1.checkout(utils_1.getEnv('GITHUB_REF'));
    let currentContent = await determine_content_1.determineContent();
    core_1.info(`Current Content: ${currentContent}`);
    core_1.setOutput('current-content', currentContent);
    if (currentContent !== previousContent && core_1.getInput('create-tag') !== 'false') {
        let tagTemplate = core_1.getInput('tag-template');
